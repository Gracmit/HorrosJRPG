...
public class SkillModificationProsessor : UnityEditor.AssetModificationProcessor
{
    private static AssetMoveResult OnWillMoveAsset(string sourcePath, string destinationPath)
    {
        ...
        CheckHealSkillMoveResult(sourcePath, destinationPath);
    ...
    private static void CheckHealSkillMoveResult(string sourcePath, string destinationPath)
    {
        var skill = AssetDatabase.LoadMainAssetAtPath(sourcePath) as HealSkill;
        if (skill == null)
        {
            return;
        }
