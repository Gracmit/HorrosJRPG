Shader "Hidden/InTerra/InTerra-AddPass" 
{
    Properties {
        ...
        [Toggle(_TERRAIN_DISTANCEBLEND)] _DistanceBlend("HIDE TILING", Float) = 0
        _HT_distance("Distance",  vector) = (3,10,0,25)
        _HT_distance_scale("Scale",   Range(0,0.5)) = 0.25
        _HT_cover("Cover strenght",   Range(0,1)) = 0.6
        [Toggle(_TERRAIN_BLEND_HEIGHT)] _HeightBlend("HEIGHTMAP BLENDING", Float) = 0
        ...
        [Toggle(_TERRAIN_TRIPLANAR)] _Triplanar("TRIPLANAR TEXTURING", Float) = 0
