#include "InTerra_Functions.hlsl"
    ...
    void SplatmapMix_float(float heightOffset, float3 worldPos, float3 tangentViewDirTerrain, float3 worldViewDir, float4 worldNormal, float3 worldTangent, float3 worldBitangent, float4 mUV, out half3 albedo, out half3 mixedNormal, out half smoothness, out half metallic, out half occlusion)
#else
...
#endif
{
    ...
    //====================================================================================
        ...
        float3 tint = SAMPLE_TEXTURE2D(_TerrainColorTintTexture, sampler_TerrainColorTintTexture, terrainUV).rgb;
        #ifndef _LAYERS_ONE     
        ...
        #endif          
    #else
        float3 tint = SAMPLE_TEXTURE2D(_TerrainColorTintTexture, sampler_TerrainColorTintTexture, uvMainAndLM.xy).rgb;
        ...
        #ifdef INTERRA_OBJECT
            float weight;
            TriplanarOneToAllSteep(splatControl, (1 - worldNormal.w), weight);
        #else
    ...
    //================================================================================
        ...
        float2 mainParallaxOffset = 0;
            ...
            mainParallaxOffset = ParallaxOffset(_MainMask, sampler_MainMask, _ParallaxSteps, _ParallaxHeight, mainUV, mul(objectToTangent, worldViewDir), _ParallaxAffineSteps);
